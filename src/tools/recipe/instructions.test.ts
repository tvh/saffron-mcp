...
import { instructionsSchema, instructionsFromSlate, type Instruction } from './instructions';
...
describe('Instructions roundtrip tests', () => {
  describe('Basic roundtrip functionality', () => {
    it('should roundtrip a simple paragraph instruction', () => {
      const original: Instruction[] = [
        { type: 'paragraph', text: 'Mix the ingredients together' }
      ];
  ...
  describe('Edge cases and special characters', () => {
    ...
    it('should roundtrip instructions with very long text', () => {
      const longText = 'This is a very long instruction that contains a lot of detailed information about the cooking process, including specific temperatures, timing, ingredient measurements, and various techniques that should be followed carefully to ensure the best possible outcome for this particular recipe step.';
